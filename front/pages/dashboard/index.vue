    ...
    <div class="flex gap-5 h-full">
        <div class="w-full h-full">
            <div class="w-full flex gap-5 h-full">
                <div class="w-1/2 2xl:w-1/4 h-full">
                    <FormsMakePhoto class="h-full"/>
                </div>
                <div class="w-1/2 2xl:w-3/4 sticky top-0 h-full">
                    <UCard
                        class="sticky top-0"
                        :ui="{
                    ...
                    >
                        <TransitionGroup name="list-left" class="flex flex-wrap gap-5 columns-3 h-full " tag="div">
                            <div class="w-full xl:w-1/4 overflow-hidden rounded-xl flex flex-wrap" v-for="task in tasks.imagePredicts" :key="task.id">
